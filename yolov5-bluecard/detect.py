...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/home/data/yolov5_pt/runs/exp21/weights/ckpt_model_467_800_0.0387.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='/home/sysman/zlf/3rd_add_016299.jpg', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--output', type=str, default='inference/20201208', help='output folder')  # output folder
