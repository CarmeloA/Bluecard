...
def test(data,
    ...
    if not training:
        ...
        print('path:',path)# path to val/test images
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='tiny_qnnpack_0824_56_0.008.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='data/sysman/coco_bluecard.yaml', help='*.data path')
